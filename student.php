...
function discussion()
{
	$.post("discussion.php",function(data)
	{
		$("#content").html(data);
	});
}
      ...
      <div class="container">
         ...
         <nav>
            <ul id="tabs">
               ...
               <li id="collegec" title="college" class="not"><a id="college" title="college" href="#" class="m2" onclick="cls(this.id),discussion()">Discussion</a></li>
